...
// image default alt
if( !function_exists( 'bcharity_img_default_alt' ) ){
	function bcharity_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'bcharity_img_tag' ) ){
	function bcharity_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = bcharity_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'bcharity_anchor_tag' ) ){
	function bcharity_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'bcharity_heading_tag' ) ){
	function bcharity_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'bcharity_paragraph_tag' ) ){
	function bcharity_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'bcharity_other_tag' ) ){
	function bcharity_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'bcharity_button_element ' ) ){
	function bcharity_button_element( array $args ){
