...
function bcharity_widgets_init() {
    // sidebar widgets 
    
    register_sidebar(array(
        'name'          => esc_html__('Sidebar widgets', 'bcharity'),
        'description'   => esc_html__('Place widgets in sidebar widgets area.', 'bcharity'),
        'id'            => 'sidebar_widgets',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer One', 'bcharity' ),
			'id'            => 'footer-1',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Two', 'bcharity' ),
			'id'            => 'footer-2',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Three', 'bcharity' ),
			'id'            => 'footer-3',
...
add_action( 'widgets_init', 'bcharity_widgets_init' );
