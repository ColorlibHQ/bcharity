...
----------------------------------------*/
class bcharity_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('bcharity_instagram_photo',esc_html__('[ Bcharity ] Intagram Photo','bcharity'),array(
			'description' => esc_html__('Bcharity Instagram Photo Widget','bcharity'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'bcharity');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'bcharity'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'bcharity'); ?></label>
...
if(!function_exists('bcharity_instagram_widgets')):
	function bcharity_instagram_widgets(){
		register_widget('bcharity_instagram_photo');
	}
	add_action('widgets_init','bcharity_instagram_widgets');
endif;
