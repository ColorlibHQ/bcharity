(function( $ , api){
    ...
    api.section( 'bcharity_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'bcharity_about_section' , function( section ){
    ...
    api.section( 'bcharity_blog_section' , function( section ){
    ...
    api.section( 'bcharity_portfolio_section' , function( section ){
    ...
    api.section( 'bcharity_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-bcharity_contact_custom_formshortcode'),
                selector = $('#_customize-input-bcharity_contact_formshortcode');
    ...
    // General section
    api.section( 'bcharity_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#bcharity_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-bcharity_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-bcharity_preloader_color' );
            ...
            var $backtotop          = $( '#bcharity_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-bcharity_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-bcharity_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'bcharity_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#bcharity_footer_widget_toggle');
